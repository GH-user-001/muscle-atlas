...
## Muscle Atlas adaptations
Muscular and skeletal meshes selected from ashemag/human-atlas; repacked without further geometric simplification. Original mesh names and IDs preserved. Exercise motion uses illustrative procedural joint deformation and color highlighting, not measured muscle activation or clinically validated biomechanics.
